 ...
 * @author karti
 */
public class EditAlternatif extends javax.swing.JDialog {
    Alternatif alt;

    /**
     * Creates new form EditAlternatif
     */
    public EditAlternatif(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        txtNamaKos.setText(alt.getNama_kos()); 
        txtAlamat.setText(alt.getAlamat()); 
        txtHarga.setText(alt.getHarga_sewa());
        txtLuas.setText(alt.getLuas_kamar());

        int list = cmbJenis.getItemCount();
        for (int i = 0; i < list; i++) {
            String data = cmbJenis.getItemAt(i);
            String[] parsing = data.split("-");
            String id = parsing[0];
            if(id.equalsIgnoreCase(alt.getJenis_kos())){
                cmbJenis.setSelectedItem(data); 
                break;
            }
        }
        
        int list2 = cmbFasilitas.getItemCount();
        for (int i = 0; i < list; i++) {
            String data = cmbFasilitas.getItemAt(i);
            String[] parsing = data.split("-");
            String id = parsing[0];
            if(id.equalsIgnoreCase(alt.getFasilitas())){
                cmbFasilitas.setSelectedItem(data); 
                break;
            }
        }
        
        int list3 = cmbLokasi.getItemCount();
        for (int i = 0; i < list; i++) {
            String data = cmbLokasi.getItemAt(i);
            String[] parsing = data.split("-");
            String id = parsing[0];
            if(id.equalsIgnoreCase(alt.getLokasi())){
                cmbLokasi.setSelectedItem(data); 
                break;
            }
        }
        
        int list4 = cmbKeamanan.getItemCount();
        for (int i = 0; i < list; i++) {
            String data = cmbKeamanan.getItemAt(i);
            String[] parsing = data.split("-");
            String id = parsing[0];
            if(id.equalsIgnoreCase(alt.getKeamanan())){
                cmbKeamanan.setSelectedItem(data); 
                break;
            }
        }
        
        
        txtKeterangan.setText(alt.getKeterangan());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditAlternatif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditAlternatif dialog = new EditAlternatif(new javax.swing.JFrame(), true);
    ...
    private void EditData() {
        try {
            ...
            if(nama_kos.isEmpty() || harga_sewa.isEmpty() || luas_kamar.isEmpty()){
                ...
                //siapkan query
                String sql = "UPDATE data_kos "
                        + "SET nama_kos='"+nama_kos+"',"
                        + "alamat='"+alamat+"',"
                        + "harga_sewa='"+new_harga+"',"
                        + "luas_kamar='"+new_luaskamar+"',"
                        + "jenis_kos='"+newJKOS+"',"
                        + "fasilitas='"+newFAS+"',"
                        + "lokasi='"+newLKS+"',"
                        + "keamanan='"+newKM+"',"
                        + "keterangan='"+keterangan+"' "
                        + "WHERE id_kos='"+alt.getId()+"'";
